...
export async function fetchCars(filters: FilterProps) {
    ...
    const headers = {
        'X-Rapidapi-Key': '408f0a4873msh65f4caf176d4d62p1a0cd7jsn9dc35d7863fb',
...
export const generateCarImageUrl = (car: CarProps, angle?
    ...
    url.searchParams.append('customer', process.env.NEXT_PUBLIC_IMAGIN_API_KEY || 'images.remotePatterns');
